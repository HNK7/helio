...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.player'
        db.alter_column('tourney_card', 'player_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tourney.Player'], unique=True))

        # Adding unique constraint on 'Card', fields ['player']
        db.create_unique('tourney_card', ['player_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Card', fields ['player']
        db.delete_unique('tourney_card', ['player_id'])

        # Changing field 'Card.player'
        db.alter_column('tourney_card', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tourney.Player']))
