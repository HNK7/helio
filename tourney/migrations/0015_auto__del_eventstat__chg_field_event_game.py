...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.game'
        db.alter_column('tourney_event', 'game', self.gf('django.db.models.fields.CharField')(max_length=12))
    ...
    def backwards(self, orm):
        ...
        db.create_table('tourney_eventstat', (
            ...
            ('rfid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64, null=True)),
        ...
        # Changing field 'Event.game'
        db.alter_column('tourney_event', 'game', self.gf('django.db.models.fields.CharField')(max_length=3))
    ...
    models = {
        ...
        'tourney.event': {
            ...
            'game': ('django.db.models.fields.CharField', [], {'default': "'CR'", 'max_length': '12'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
