...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Console', fields ['ip_address']
        db.delete_unique('tourney_console', ['ip_address'])

        # Changing field 'Console.machid'
        db.alter_column('tourney_console', 'machid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16))

        # Changing field 'Console.serial'
        db.alter_column('tourney_console', 'serial', self.gf('django.db.models.fields.CharField')(unique=True, max_length=5))


    def backwards(self, orm):
        
        # Changing field 'Console.machid'
        db.alter_column('tourney_console', 'machid', self.gf('django.db.models.fields.CharField')(max_length=5, unique=True))

        # Adding unique constraint on 'Console', fields ['ip_address']
        db.create_unique('tourney_console', ['ip_address'])

        # Changing field 'Console.serial'
        db.alter_column('tourney_console', 'serial', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True))
    ...
    models = {
        'tourney.card': {
            ...
            'player': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['tourney.Player']", 'unique': 'True'}),
        ...
        'tourney.console': {
            ...
            'machid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '16'}),
            'no': ('django.db.models.fields.CharField', [], {'max_length': '16', 'primary_key': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '5'})
        },
        'tourney.drawentry': {
        ...
        'tourney.entry': {
            ...
            'balance_card': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
            'balance_membership': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
            'balance_signup': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
        ...
        'tourney.preregplayer': {
            ...
            'credit': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
