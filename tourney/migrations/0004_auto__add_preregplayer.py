...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PreRegPlayer'
        db.create_table('tourney_preregplayer', (
            ('player_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tourney.Player'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('tourney', ['PreRegPlayer'])


    def backwards(self, orm):
        
        # Deleting model 'PreRegPlayer'
        db.delete_table('tourney_preregplayer')
