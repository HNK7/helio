...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.balance_signup'
        db.add_column('tourney_entry', 'balance_signup', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Entry.balance_signup'
        db.delete_column('tourney_entry', 'balance_signup')
