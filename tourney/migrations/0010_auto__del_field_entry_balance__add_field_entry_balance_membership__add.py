...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Entry.balance'
        db.delete_column('tourney_entry', 'balance')

        # Adding field 'Entry.balance_membership'
        db.add_column('tourney_entry', 'balance_membership', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'Entry.balance_singup'
        db.add_column('tourney_entry', 'balance_singup', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Entry.balance'
        db.add_column('tourney_entry', 'balance', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2), keep_default=False)

        # Deleting field 'Entry.balance_membership'
        db.delete_column('tourney_entry', 'balance_membership')

        # Deleting field 'Entry.balance_singup'
        db.delete_column('tourney_entry', 'balance_singup')
    ...
    models = {
        ...
        'tourney.entry': {
            ...
            'balance_singup': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
