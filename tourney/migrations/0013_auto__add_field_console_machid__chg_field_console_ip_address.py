...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Console.machid'
        db.add_column('tourney_console', 'machid', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=5), keep_default=False)

        # Changing field 'Console.ip_address'
        db.alter_column('tourney_console', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15, unique=True, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Console.machid'
        db.delete_column('tourney_console', 'machid')

        # Changing field 'Console.ip_address'
        db.alter_column('tourney_console', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(default=datetime.date(2013, 6, 13), max_length=15, unique=True))
    ...
    models = {
        ...
        'tourney.console': {
            ...
            'ip_address': ('django.db.models.fields.IPAddressField', [], {'max_length': '15', 'unique': 'True', 'null': 'True'}),
            'mac_address': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '12'}),
            'machid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '5'}),
