...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PreRegPlayer.balance'
        db.delete_column('tourney_preregplayer', 'balance')

        # Adding field 'PreRegPlayer.credit'
        db.add_column('tourney_preregplayer', 'credit', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PreRegPlayer.balance'
        db.add_column('tourney_preregplayer', 'balance', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=8, decimal_places=2), keep_default=False)

        # Deleting field 'PreRegPlayer.credit'
        db.delete_column('tourney_preregplayer', 'credit')
