...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PreRegPlayer.note'
        db.add_column('tourney_preregplayer', 'note', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PreRegPlayer.note'
        db.delete_column('tourney_preregplayer', 'note')
